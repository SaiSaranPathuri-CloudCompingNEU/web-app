    ...
    if (list_1 === null || list_1 === undefined) {
      ...
      if (vUser && verified) {
        ...
        return res.status(201).json({
          ...
          quantity: quantity,
          date_added: data.createdAt,
          date_last_updated: data.updatedAt,
  ...
  get: async (req, res) => {
    ...
    if (list_fetched === null || typeof list_fetched === "undefined") {
      ...
      return res.status(200).json({
        id: list_fetched.id,
        name: list_fetched.name,
        description: list_fetched.description,
        sku: list_fetched.sku,
        manufacturer: list_fetched.manufacturer,
        quantity: list_fetched.quantity,
        date_added: list_fetched.createdAt,
        date_last_updated: list_fetched.updatedAt,
        owner_user_id: list_fetched.UserId,
      });
    }
  },
